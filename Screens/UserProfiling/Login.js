    ...
    <View>
      <View style={{alignItems: 'center', marginTop: 50}}>
        ...
        <Text
          ...
          {user} <Text style={{color: '#0e98f1'}}>Login</Text>
        </Text>
      </View>
          ...
          <>
            ...
            <View style={{alignItems: 'center', marginTop: 20}}>
              <TouchableOpacity
                ...
                style={{
                  padding: 10,
                  backgroundColor: isValid ? '#0e98f1' : 'grey',
                  width: '90%',
                  alignItems: 'center',
                  // borderRadius: '50%',
                  margin: 10,
              ...
              <TouchableOpacity
                ...
                <Text
                  style={{color: '#0e98f1', fontSize: 14, fontWeight: '400'}}>
                  Forgetten Password?
                </Text>
              </TouchableOpacity>
              ...
              <TouchableOpacity
                ...
                <Text style={{color: Font.TextBackground}}>
                  ...
                  <Text style={{color: '#0e98f1'}}> SignUp</Text>{' '}
                </Text>
              </TouchableOpacity>
      ...
      {/* <View style={{alignItems: 'center', marginTop: 20}}>
        ...
        <TouchableOpacity
          ...
          <Text style={{color: '#0e98f1'}}>Forgetten Password?</Text>
        </TouchableOpacity>
